...
def gdal_img_info(filename):
    ...
    print("height: {}, width: {}, bands: {}".format(raster.RasterYSize, raster.RasterXSize, raster.RasterCount))
    print("x_res: {}, y_res: {}".format(xres, yres))
    print("bounds: {}".format((transform.TransformPoint(ulx, uly), transform.TransformPoint(lrx, lry))))
